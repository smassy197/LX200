...
namespace ASCOM.MaxScarzellaLX200.Focuser
{
    ...
    public partial class SetupDialogForm : Form
    {
        ...
        private void CmdOK_Click(object sender, EventArgs e) // OK button event handler
        {
            ...
            if (cmbbound.SelectedItem != null)
            {
                FocuserHardware.baudRate = cmbbound.SelectedItem.ToString();
                tl.LogMessage("Setup OK", $"Baud Rate: {cmbbound.SelectedItem}");
            }
        }
        ...
        private void InitUI()
        {
            ...
            // Popola cmbbound con i baud rate standard
            cmbbound.Items.Clear();
            cmbbound.Items.AddRange(new object[] { "1200", "2400", "4800", "9600", "19200", "38400", "57600", "115200" });
            cmbbound.SelectedItem = "9600"; // Imposta il valore di default,
        ...
        private void btnOpenControlForm_Click(object sender, EventArgs e)
        {
            var controlForm = new FocuserControlForm();
            controlForm.Show();
        }
    }
}