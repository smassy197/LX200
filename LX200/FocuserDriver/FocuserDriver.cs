...
//
// ASCOM Focuser driver for MaxScarzellaLX200
//
...
namespace ASCOM.MaxScarzellaLX200.Focuser
{
    ...
    //
    // Your driver's DeviceID is ASCOM.MaxScarzellaLX200.Focuser
    //
    // The COM Guid attribute sets the CLSID for ASCOM.MaxScarzellaLX200.Focuser
    // The COM ClassInterface/None attribute prevents an empty interface called _MaxScarzellaLX200 from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("a001d3f5-9cd7-48af-b181-059167cbc82b")]
    [ProgId("ASCOM.MaxScarzellaLX200.Focuser")]
    [ServedClassName("ASCOM Focuser Driver for MaxScarzellaLX200")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Focuser : ReferenceCountedObjectBase, IFocuserV4, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MaxScarzellaLX200"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Focuser()
        {
            try
            {
                ...
                tl = new TraceLogger("", "MaxScarzellaLX200.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.MaxScarzellaLX200.Focuser", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
